...
## Recent Changes
- 005-resource-playlists: Added Python 3.12+ (backend), TypeScript 5.4+ (frontend) + FastAPI, React 18, TanStack Query, Shadcn/UI + Tailwind CSS
- 004-drift-calendar-heatmap: Added TypeScript 5.7 (frontend), Python 3.12 (backend) + React 18, TanStack Query v5, Axios, lucide-react (frontend); FastAPI, psycopg3 (backend)
